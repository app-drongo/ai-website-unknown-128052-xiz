...
const DEFAULT_FEATURES = {
  ...
  mainTitle: 'Everything You Need to Succeed',
  mainTitleHighlight: 'All in One Place',
  mainDescription:
    'Our comprehensive platform combines powerful tools, seamless integrations, and intelligent automation to help you achieve your goals faster and more efficiently.',
  feature1Title: 'Lightning-Fast Performance',
  feature1Description:
    'Experience blazing-fast load times and real-time updates with our optimized infrastructure and edge computing technology.',
  feature1Badge: 'Performance',
  feature2Title: 'Enterprise-Grade Security',
  feature2Description:
    'Bank-level encryption, multi-factor authentication, and compliance with industry standards keep your data safe and secure.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile-First Design',
  feature3Description:
    'Access all features seamlessly across devices with our responsive design and native mobile applications.',
  feature3Badge: 'Mobile',
  feature4Title: 'Global Scalability',
  feature4Description:
    'Scale effortlessly from startup to enterprise with our cloud infrastructure that grows with your business needs.',
  feature4Badge: 'Scale',
  feature5Title: 'Advanced Analytics',
  feature5Description:
    'Make data-driven decisions with comprehensive dashboards, custom reports, and predictive insights powered by AI.',
  feature5Badge: 'Analytics',
  feature6Title: 'Smart Automation',
  feature6Description:
    'Streamline workflows and eliminate repetitive tasks with intelligent automation and customizable business rules.',
  feature6Badge: 'Automation',
  feature7Title: 'Seamless Integrations',
  feature7Description:
    'Connect with 500+ popular tools and services through our robust API and pre-built integrations marketplace.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Support',
  feature8Description:
    'Get help when you need it with 24/7 customer support, comprehensive documentation, and dedicated success managers.',
  feature8Badge: 'Support',
  feature9Title: 'Privacy by Design',
  feature9Description:
    'Your data privacy is paramount. We never sell your information and give you complete control over your data.',
  feature9Badge: 'Privacy',
  ctaQuestion: 'Ready to transform your workflow?',
