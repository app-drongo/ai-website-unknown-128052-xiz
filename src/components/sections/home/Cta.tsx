...
const DEFAULT_CTA = {
  ...
  mainTitle: 'Ready to Unlock Your',
  mainTitleHighlight: 'Full Potential?',
  description:
    'Join thousands of forward-thinking businesses who have revolutionized their operations with our cutting-edge solutions. Experience the difference with our comprehensive platform.',
  ...
  stat3Value: '200+',
  stat3Label: 'Solutions',
  stat4Value: '24/7',
  stat4Label: 'Expert Support',
  feature1Title: 'Instant Results',
  feature1Description: 'See immediate improvements from day one',
  feature2Title: 'Proven Reliability',
  feature2Description: 'Battle-tested solutions with guaranteed performance',
  feature3Title: 'Simple Integration',
  feature3Description: 'Seamlessly fits into your existing workflow',
} as const;
