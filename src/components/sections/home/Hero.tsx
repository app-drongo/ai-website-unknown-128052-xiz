...
const DEFAULT_HERO = {
  ...
  description:
    'Unlock the power of your data with our comprehensive analytics platform. Make informed decisions, optimize performance, and drive growth with real-time insights.',
  features: [
  ...
  statsLabel1: 'Data Accuracy',
  statsValue1: '99.9% uptime',
  statsLabel2: 'Processing Speed',
  statsValue2: '< 100ms response',
} as const;
