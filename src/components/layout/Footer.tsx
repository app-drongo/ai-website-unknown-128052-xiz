...
const DEFAULT_FOOTER = {
  logoText: 'DataFlow',
  companyDescription:
    'Empowering businesses with intelligent data analytics and automation tools. Join over 10,000 companies who trust DataFlow to streamline their operations and drive growth through data-driven insights.',
  contactEmail: 'support@dataflow.com',
  ...
  newsletterDisclaimer:
    'Get weekly product updates, feature releases, and industry insights. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 DataFlow. All rights reserved.',
  madeWithText: 'by the DataFlow team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/dataflow',
  social2Href: 'https://facebook.com/dataflow',
  social3Href: 'https://instagram.com/dataflow',
  social4Href: 'https://linkedin.com/company/dataflow',
  social5Href: 'https://github.com/dataflow',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Analytics Dashboard', href: '#features', editableId: 'link-footer-features' },
        { name: 'Pricing Plans', href: '#pricing', editableId: 'link-footer-pricing' },
        { name: 'Report Templates', href: '/templates', editableId: 'link-footer-templates' },
        { name: 'API Integrations', href: '/integrations', editableId: 'link-footer-integrations' },
        { name: 'Developer API', href: '/api', editableId: 'link-footer-api' },
        { name: 'API Documentation', href: '/docs', editableId: 'link-footer-documentation' },
      ],
    },
    {
      title: config.section2Title,
      links: [
        { name: 'About DataFlow', href: '#about', editableId: 'link-footer-about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'User Community', href: '/community', editableId: 'link-footer-community' },
        ...
        { name: 'Customer Stories', href: '/case-studies', editableId: 'link-footer-case-studies' },
